...
!function(){angular.module("wiki",[])}();var wikistore={name:"Nexonia",tabs:[{name:"Montreal",icon:"ico1",children:[{name:"bloc 1",icon:"ico2",details:{},children:[]},{name:"bloc 2",icon:"ico3",details:{},children:[]},{name:"bloc 3",icon:"ico3",details:{},children:[]}]}]};
!function(){var r=angular.module("wiki");r.controller("CategoryController",function(){console.log("CategoryController launched")}),r.directive("categoryTabs",function(){return{restrict:"E",templateUrl:"app/category-tabs.html",controller:"CategoryController"}})}();
!function(){var e=angular.module("wiki");e.controller("ItemtreeController",function(){console.log("ItemtreeController launched")}),e.directive("itemTreeview",function(){return{restrict:"E",templateUrl:"app/item-treeview.html",controller:"ItemtreeController"}})}();
!function(){var t=angular.module("wiki");t.controller("ItemdetailController",function(){console.log("ItemdetailController launched")}),t.directive("itemDetail",function(){return{restrict:"E",templateUrl:"app/item-detail.html",controller:"ItemdetailController"}})}();
