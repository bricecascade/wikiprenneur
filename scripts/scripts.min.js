...
!function(){angular.module("wiki",[])}();var wikistore={name:"Nexonia",tabs:[{name:"Montreal",icon:"ico1",children:[{name:"bloc M1",icon:"ico2",details:{},children:[]},{name:"bloc M2",icon:"ico3",details:{},children:[]},{name:"bloc M3",icon:"ico3",details:{},children:[]}]},{name:"Toronto",icon:"ico2",children:[{name:"bloc T1",icon:"ico2",details:{},children:[]}]}]};
!function(){var e=angular.module("wiki");e.controller("ItemtreeController",function(){console.log("ItemtreeController launched"),this.tabs=wikistore.tabs,console.log(this.tabs)}),e.directive("itemTreeview",function(){return{restrict:"E",templateUrl:"app/item-treeview.html",controller:"ItemtreeController"}})}();
